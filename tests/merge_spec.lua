...
describe("merge", function()
  ...
  describe("parse_profile_key", function()
    it("returns just set_name for plain key", function()
      local set, tk = merge.parse_profile_key("debug")
      assert.equals("debug", set)
      assert.is_nil(tk)
    end)

    it("splits set_name and tool_key", function()
      local set, tk = merge.parse_profile_key("debug:ninja-gcc")
      assert.equals("debug", set)
      assert.equals("ninja-gcc", tk)
    end)

    it("handles tool_key with colons", function()
      local set, tk = merge.parse_profile_key("debug:ninja:extra")
      assert.equals("debug", set)
      assert.equals("ninja:extra", tk)
    end)
  end)
