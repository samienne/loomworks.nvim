...
- **Suggestion cache** (`health_cache.lua`, spec §16.31): the suggestion results
  ...
  when it is absent, older than `NETWORK_TTL` (~24h), keyed to another running
  version, or `opts.force` is set
