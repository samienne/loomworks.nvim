...
- **Environment inventory** (spec §16.33, `inventory.lua`): `cmd_health` first
  ...
  version, location or hint); inside, the suggestions, then "Required by this
